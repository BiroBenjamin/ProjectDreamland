...
namespace ProjectDreamland.Data.GameFiles.Characters
{
  ...
  public class BaseCharacter : BaseObject
  {
    ...
    public int CurrentResourcePoints { get; set; }
    ...
    public bool IsCollidingLeft(Rectangle targetCollision)
    {
      ...
      return thisCollision.Right + _velocity.X > targetCollision.Left &&
    ...
    {
      Rectangle thisCollision = GetCollision();
      return thisCollision.Left + _velocity.X < targetCollision.Right &&
    ...
    {
      Rectangle thisCollision = GetCollision();
      return thisCollision.Bottom + this._velocity.Y > targetCollision.Top &&
    ...
    public bool IsCollidingBottom(Rectangle targetCollision)
    {
      int zindex = ZIndex;
      Rectangle thisCollision = GetCollision();
      return thisCollision.Top + this._velocity.Y < targetCollision.Bottom &&
    ...
    public override void Update(GameTime gameTime, List<BaseObject> components)
    {
      ...
      if (CurrentResourcePoints < MaxResourcePoints && _resourceTimer.Count(gameTime) == 0)
      {
        AddResource();
        _resourceTimer.Reset();
      }
      if(CharacterState == CharacterStatesEnum.Dead && _respawnTimer.Count(gameTime) == 0)
      {
        CharacterState = CharacterStatesEnum.Alive;
